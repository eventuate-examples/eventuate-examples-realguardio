...
for dir in realguardio-orchestration-service realguardio-oso-integration-service realguardio-customer-service realguardio-security-system-serviceend-to-end-tests; do
       cd "$ROOT_DIR"
       if [ -d "$dir" ]; then
        echo ""
        echo "Checking $dir..."

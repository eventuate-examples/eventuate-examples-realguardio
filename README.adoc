...
5. https://microservices.io/post/architecture/2025/12/09/microservices-authn-authz-part-5-using-an-authorization-service.html[Implementing complex authorization using Oso Cloud]
6. https://microservices.io/post/architecture/2026/02/13/microservices-authn-authz-part-6-oso-local-authorization.html[Implementing complex authorization using Oso Cloud local authorization]

== Application architecture

image::https://microservices.io/i/microservices-auth/Security-Architecture_Full.png[]
...
* `IAM Service` (Spring Authorization Service) - handles authentication including the login page and issues access tokens and ID tokens to BFF.
* https://www.osohq.com/docs/get-started/introduction[`Oso Authorization Service`] - a cloud-based authorization service that makes authorization decisions based on declarative authorization rules
* Backend services:
** `Security System Service` - manages `SecuritySystems` domain entities.
** `Customer Service` - manages `Customers` domain entities.
** `Orchestration Service` - orchestrates the creation of security systems across `Customer Service` and `Security System Service` using the https://microservices.io/patterns/data/saga.html[Saga pattern]
...
* `CDC` - https://github.com/eventuate-foundation/eventuate-cdc[Eventuate transaction outbox service] that reads messages from service outbox tables and sends them to Kafka.
...
There are the following code guides for each of the articles with more on the way:

* link:./docs/guides/part-2-authentication-code-guide.md[Part 2 - Implementing authentication]
* link:./docs/guides/part-3-jwt-authorization-code-guide.md[Part 3 - Implementing JWT-based authorization]
* link:./docs/guides/part-4-fetch-and-replicate-authorization-code-guide.md[Part 4 - Implementing authorization using fetch and replicate]
* link:./docs/guides/part-5-oso-cloud-authorization-code-guide.md[Part 5 - Implementing complex authorization using Oso Cloud]
* link:./docs/guides/part-6-oso-cloud-local-authorization-code-guide.md[Part 6 - Implementing complex authorization using Oso Cloud local authorization]

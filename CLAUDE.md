...
- `realguardio-customer-service/gradlew`
- `realguardio-security-system-service/gradlew`
- `realguardio-orchestration-service/gradlew`
- `realguardio-oso-integration-service/gradlew`
- `end-to-end-tests/gradlew`

Always run Gradle commands from within the specific service directory:
```bash
cd /path/to/realguardio-customer-service && ./gradlew check
```

...
public class SecuritySystemServiceContainer extends GenericContainer<SecuritySystemServiceContainer> {
    
    private static final Logger logger = LoggerFactory.getLogger(SecuritySystemServiceContainer.class);
    private static final int CONTAINER_PORT = 3001;
    private final PostgreSQLContainer<?> postgres;
    private final GenericContainer<?> iamService;
    
    public SecuritySystemServiceContainer(PostgreSQLContainer<?> postgres, GenericContainer<?> iamService) {

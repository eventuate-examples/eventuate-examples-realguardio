...
oso-cloud tell has_role CustomerEmployee:bob SECURITY_SYSTEM_DISARMER Customer:foo
...
oso-cloud tell has_role CustomerEmployee:mary SECURITY_SYSTEM_DISARMER Location:loc3
...
oso-cloud tell has_role Team:ops-t1 SECURITY_SYSTEM_DISARMER Location:loc1